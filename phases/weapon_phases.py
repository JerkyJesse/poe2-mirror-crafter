        ...
        "alternatives": {
            ...
            "10.2": [
                ...
                },
                {
                    ...
                    "risk": "very low",
                    "description": "Combine Hinekora's Lock (preview outcome) with Omen of Sanctification (guaranteed success). Preview the sanctify and if the result is good, the Omen guarantees it lands. Best of both worlds.",
                },
            ],
        },
        "orbs_used_overrides": {
